...
public class Configs {
	...
	// base config
	public static final String TIME_FORMATTER = "dd-MM-yyyy HH:mm";
	public static String[] SUPPORT_RUSH_ORDER_PROVINCES = {"Hà Nội"};
	public static Integer[] MEDIA_SUPPORT_RUSH_ORDER_IDS = {12, 34, 44, 21};
	public static Integer FEE_PER_MEDIA_STRATEGY_2 = 1;
